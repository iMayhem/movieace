#!/bin/bash
# ============================================================================
# MovieAce VPS Deployment Script for Oracle Linux
# ============================================================================
...
echo -e "${BLUE}"
echo "═══════════════════════════════════════════════════════════"
echo "  MovieAce VPS Deployment (Oracle Linux)"
...
# Configure SELinux to allow Nginx to connect
...
echo "  • Node Resolver:  $(sudo -u $SUDO_USER pm2 list | grep movieace-resolver | awk '{print $10}' || echo 'checking...')"
echo ""
echo "Endpoints:"
